...
//	private static String prevStartDate;
	...
	public boolean add(Stock stock) throws SQLException {
		...
		add(stock.getSymbol(), stock.getDate(), stock.getPrice(), stock.getDividend(), stock.getSplit());
	...
	private boolean add(String symbol, String date, double price, double dividend, double split) throws SQLException {
		connectionOpened();
